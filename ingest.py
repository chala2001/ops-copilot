...
# This script loads documents from multiple sources,
# splits them into chunks, converts them to vectors,
# and stores them in ChromaDB.

import os
import sys
from pathlib import Path  # Better file path handling than strings

# LangChain document loaders — each handles a different file type
from langchain_community.document_loaders import (
    DirectoryLoader,    # Loads all files in a folder
    TextLoader,         # Loads plain text / markdown files
    PyPDFLoader,        # Loads PDF files
    ConfluenceLoader,   # Loads pages from Confluence
    GitLoader,          # Loads files from a Git repository
)

# Text splitter — splits long documents into smaller chunks
...
# ── Helper: Load Confluence documents ────────────────────
...
# ── Helper: Store chunks in ChromaDB ─────────────────────
